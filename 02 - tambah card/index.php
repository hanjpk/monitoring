...
<body>
    <div class=" navbar-expand-lg navbar-dark bg-gradient py-3" style="color: white; width: auto;">
        <a class="navbar-brand font-weight-bold" href="{{ config('app.url') }}">
    ...
    <marquee id="alertspta" bgcolor="yellow" behavior="scroll" scrollamount="25"
        style="font-weight: bold; font-size:32px; font-family: 'Roboto Mono', monospace; margin-bottom: 2px;"></marquee>
    <marquee id="alertspch" bgcolor="yellow" behavior="scroll" scrollamount="25"
        style="font-weight: bold; font-size:32px; font-family: 'Roboto Mono', monospace; margin-bottom: 2px;"></marquee>
